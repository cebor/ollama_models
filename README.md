...
ollama create qwen3.5-27b-planning -f ./mac-m3-24gb/qwen3.5-27b-q4_K_M.txt
ollama list
```
...
ollama create qwen3.5-27b-planning -f ./pc-rtx5090-32gb/qwen3.5-27b-q4_K_M.txt
